...
For lower level interface, see the [LuaDocs for API details](https://nyxvim.one/nvim-colorizer.lua/modules/colorizer.html) or use `:h colorizer` once installed.

## Extras

Documentaion is generated using ldoc. See
[scripts/gen_docs.sh](https://github.com/NyxVim/nvim-colorizer.lua/blob/main/scripts/gen_docs.sh)
